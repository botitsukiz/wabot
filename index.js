...
autoketik = false;
prefixStatus = true;
targetpc = "6285869002046"; 
owner = "6285869002046"; 
fakeyoi = "DEDEN GANZ シ︎"; 
HunterApi = "Ikyy69", 
xchillds = 'XChillDs' 
hardi = 'hardianto', 
valkey = "rivalgans", 
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6285869002046@s.whatsapp.net`]
...
/*const reply = (teks) => {
			itsmevall.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6285869002046?text=Assalamualaikum`}}})
		}*/
...
// Katalog
const reply = (teks) => {
             res = itsmevall.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*Deden Ganz*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
             itsmevall.relayWAMessage(res)
        }
const fakewa = (teks) => {        
itsmevall.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6285869002046?text=Assalamualaikum`}}})
		}
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6285869002046`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6285869002046`,
                "thumbnailUrl": "https://j.top4top.io/p_20682m4yj0.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6285869002046`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6285869002046@s.whatsapp.net";
...
*「 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 DEDEN GANZ 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 Deden Ganz︎', imageMessage: imageMsg,
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`Hai ${pushname}\n ${ucapanWaktu} Kak 👋`
               ...
               buttons = [{buttonId:`vallgans`, 
               buttonText:{displayText: 'Menu Bot🤖︎'},type:1},
               {buttonId:`owner`,buttonText:{displayText:'Creatorシ✍️︎'},type:1},
               {buttonId:`command`,buttonText:{displayText:'Menu2🌺シ︎'},type:1}]
...
groups = itsmevall.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "6285869002046@s.whatsapp.net"
        dtod = '6285869002046'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
case 'bugreport':
              ...
              itsmevall.sendMessage('6285869002046@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://youtube.com/c/Deden Ganz"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        itsmevall.toggleDisappearingMessages(from, 0)
...
㋛${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 DEDEN GANZシ︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
㋛${prefix}kickarea
`
sendButMessage(from, menu, ` 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 Deden Ganz︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
㋛${prefix}upswlokasi
`
sendButMessage(from, menu, ` 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 Deden Ganz`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
case 'katalog':
    ...
    "listMessage": {
      ...
      "footerText": " 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 Deden Ganz"
    }
  }, {quoted: freply})
...
case 'script':
		case 'sc':
		case 'sourcecode':
		itsmevall.sendMessage(from, { text: "silahkan hubungi owner", matchedText: 'nopee', description: "", title: "Ngapain Om?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
...
buttons = [{buttonId: `${prefix}listnulis`,buttonText:{displayText: `List Nulis🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 Deden Ganz︎', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @raditnation12_ ☹︎`,buttons,headerType:4}
...
sendButMessage(from, tiyo, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 Deden Ganz︎`, [
            {              
...
itsmevall.sendMessage(_.jid, 
			...
			"footerText": '𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 Deden Ganz︎',
			"buttons": [
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 Deden Ganz', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @raditnation12_ ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
break
...
case 'listnulis':
  ...
  🌹 ${prefix}nulis Itsukibot
  🌹 ${prefix}foliokanan Itsuki
  🌹 ${prefix}foliokiri Itsuki
  🌹 ${prefix}nuliskanan Itsuki
  🌹 ${prefix}nuliskiri Itsuki`)
  break
case 'foliokiri':
if (!c) return reply('Textnya mana gan?')
reply(mess.wait)
...
itsmevall.sendMessage(from, stdout, text, term)
      ...
      default:
		if (hour_now >= '02:00' && hour_now <= '04:00') {
          console.log(color('[Pesan Bot]', 'cyan'), color('Hayuuuk begadang yah? tak jewer lho :)', 'yellow'), color('(😊)', 'white'))
          }
        ...
        if (hour_now >= '17:00' && hour_now <= '18:00') {
          console.log(color('[Pesan Bot]', 'cyan'), color('Bentar Lagi Maghrib ya kak', 'yellow'), color('(😆)', 'white'))
          }
        ...
        if (hour_now >= '20:00' && hour_now <= '00:00') {
          ...
          if (hour_now >= '00:00' && hour_now <= '02:00') {
           console.log(color('[Pesan Bot]', 'cyan'), color('Udah malam kak, tidur sanah, besok sekolah', 'yellow'), color('(😴)', 'white'))
        }
